...
We tested \Cref{alg:division-generalized} against the state of the art modified Crandall's algorithm by Chung and Hasan (CCH, \Cref{alg:cch}), as well as the built in truncated division algorithm in Gnu MultiPrecision Library, GMP~\cite{granlund2010gnu}.
